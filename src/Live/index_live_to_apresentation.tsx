              ...
              <>
                ...
                {menu &&(
                  ...
                  <View style={{flex:1,width:'99%'}}>
                        <View style={{height:'90%',borderWidth:1,borderColor:'black'}}>
                            ...
                            <ScrollView style={{width:'100%',height:'100%', top:10}}>
                                <View style={{width:'100%',height:'100%',flexDirection:'row',flexWrap:'wrap'}}>
                                            {data.map((item)=>
                                                       <View style={{width:180,height:180,borderWidth:1,borderColor:'white',marginLeft:10,borderRadius:5}}>
                        ...
                        <TouchableOpacity style={{width:70,height:70,backgroundColor:'gray',borderRadius:200/2,top:-100,left:160,alignItems:'center',justifyContent:'center'}} onPress={()=> navigation.navigate('login')}><Image source={Video_icon} style={{width:20,height:20}}/></TouchableOpacity>
...
export default Live_Apresentation;